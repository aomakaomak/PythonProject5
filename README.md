...
## Файл transaction_csv_xlsx.py
Содержит функции для извлечения данных из файлов формата
csv и xlsx.

## Файл search_description.py
Содержит функцию для поиска операции по ключевому слову в описании.

## Файл transaction_counter.py 
Содержит функцию подсчета количества операций.

## Файл main.py 
Связывает воедино логику работы всей программы.
